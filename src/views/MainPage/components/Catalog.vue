        ...
        <div class="shadow sticky top-44">
          ...
          <div class="rounded-b-lg">
            <div v-for="(item, index) of getCategoriesWithProducts.data" :key="index"
                 ...
                 class="relative flex items-center justify-between px-2 py-1 cursor-pointer dark:text-whiteColor hover:bg-mainColor hover:text-whiteColor transition-all dark:bg-darkBgColor dark:hover:bg-mainColor"
              ...
              <div
                  ...
                  class="absolute left-full h-full w-full">
                <div
                    v-for="(it, ind) of item.sub_category" v-if="openedTab === index" :key="ind"
                    class="flex items-center dark:bg-darkBgColor dark:hover:bg-mainColor hover:bg-mainColor"
                    @mouseover="openedTab = index">
                  <img :src="it.img" alt="" class="w-10 h-10 object-contain mr-2">
      ...
      <div class="w-full lg:w-3/4">
        <div class="mb-10">
          ...
          <div class="flex justify-between flex-wrap">
            <div
                v-for="(item, index) of getCategoriesWithProducts.data"
                :key="index"
                class="w-half dark:bg-darkBgColor dark:text-whiteColor lg:w-fourth mb-2 bg-whiteColor p-4 rounded-2xl cursor-pointer hover:bg-mainColor hover:text-whiteColor transition-all">
        ...
        <div class="relative">
          <div
            ...
            <div v-for="(item, index) of getCategoriesWithProducts.data" :key="index" class="mb-10">
              ...
              <div class="flex justify-between flex-wrap overflow-x-auto overflow-y-hidden">
                <div
                    v-for="(it, ind) of item.sub_category"
                    :key="ind"
                    class="flex justify-between w-half">
                  <div
                      v-for="(ite, inde) of it.products"
                      :key="inde"
                      class="flex flex-col dark:bg-darkBgColor dark:text-whiteColor justify-between w-[300px] mr-3 mb-2 bg-whiteColor p-4 rounded-2xl cursor-pointer shadow hover:bg-mainColor hover:text-whiteColor transition-all relative">
                    <img alt="" class="absolute left-3 top-3 w-10 h-10 object-contain" src="@/assets/img/logo_hor.png">
                    <img :src="ite.img" alt="" class="w-32 h-32 mx-auto object-contain">
                    <p class="text-center font-semibold">{{ ite.name }}</p>
                    <p class="text-base font-semibold text-center my-3">{{ ite.price }} тнг.</p>
