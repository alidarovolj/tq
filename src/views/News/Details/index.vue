<template>
  <div class="pt-24 lg:pt-10">
    <div v-if="getNewsDetails" class="container mx-auto px-4 lg:px-0">
      ...
      <div class="w-1/2 mx-auto flex items-center justify-between mb-4">
      ...
      <div v-if="$i18n.locale === 'ru'" v-html="getNewsDetails.data.content"></div>
      <div v-else v-html="getNewsDetails.data.content_kz"></div>
    </div>
  </div>
</template>
